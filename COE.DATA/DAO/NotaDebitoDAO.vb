...
Public Class NotaDebitoDAO
    ...
    'Public Function CreateXML(IDNotaDebito As Int32) As String
    ...
    '    NotaDebitoBE = Me.GetByID(IDNotaDebito)

    '    'Se obtiene el nombre del archivo XML
    '    NombreArchivo = EmisorBE.NumeroRUC
    '    NombreArchivo &= "-" & "08" & "-" & NotaDebitoBE.t08_numcorrelativo
    ...
    '    writer.WriteStartElement("DebitNote")
    ...
    '    writer.WriteElementString("cbc:ID", NotaDebitoBE.t20_tipmonto_c14) ' NotaCreditoBE.totalvalorventaoperaciongravadascodigo)
    '    writer.WriteStartElement("cbc:PayableAmount")
    '    writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02) '   NotaCreditoBE.tipomoneda)
    '    writer.WriteString(NotaDebitoBE.t20_totalvalorventagravadas) '   NotaCreditoBE.totalvalorventaoperaciongravadas)
    '    writer.WriteEndElement()
    '    writer.WriteEndElement()

    '    'Tag Catálogo No. 14 - 1002 Total valor de venta - operaciones inafectas
    '    'writer.WriteStartElement("sac:AdditionalMonetaryTotal")
    '    'writer.WriteElementString("cbc:ID", NotaCreditoBE.t21_tipmonto_c14) ' NotaCreditoBE.totalvalorventaoperacioninafectascodigo)
    '    'writer.WriteStartElement("cbc:PayableAmount")
    '    'writer.WriteAttributeString("currencyID", NotaCreditoBE.t30_tipomoneda_c02) 'NotaCreditoBE.tipomoneda)
    '    'writer.WriteString(NotaCreditoBE.t21_totalvalorventainafectas) '   .totalvalorventaoperacioninafectas)
    '    'writer.WriteEndElement()
    '    'writer.WriteEndElement()

    '    'Tag Catálogo No. 14 -  1003 Total valor de venta - operaciones exoneradas
    '    'writer.WriteStartElement("sac:AdditionalMonetaryTotal")
    '    'writer.WriteElementString("cbc:ID", NotaCreditoBE.t22_tipmonto_c14) '.totalvalorventaoperacionexoneradascodigo)
    '    'writer.WriteStartElement("cbc:PayableAmount")
    '    'writer.WriteAttributeString("currencyID", NotaCreditoBE.t30_tipomoneda_c02) 'NotaCreditoBE.tipomoneda)
    '    'writer.WriteString(NotaCreditoBE.t22_totalvalorventaexonerada) '   .totalvalorventaoperacionexoneradas)
    '    'writer.WriteEndElement()
    '    'writer.WriteEndElement()

    '    ''Tag Catálogo No. 14 -  1004 Total valor de venta – Operaciones gratuitas No se tiene este campo
    '    'writer.WriteStartElement("sac:AdditionalMonetaryTotal")
    '    'writer.WriteElementString("cbc:ID", NotaCreditoBE.totalventaoperacionesgratuitascodigotipo)
    '    'writer.WriteStartElement("cbc:PayableAmount")
    '    'writer.WriteAttributeString("currencyID", FacturaBE.tipomoneda)
    '    'writer.WriteString(FacturaBE.totalventaoperacionesgratuitasvalor)
    '    'writer.WriteEndElement()
    '    'writer.WriteEndElement()

    '    'Tag Catálogo No. 14 -  2005 Total descuentos
    '    'writer.WriteStartElement("sac:AdditionalMonetaryTotal")
    '    'writer.WriteElementString("cbc:ID", NotaCreditoBE.t28_tipmonto_c14) '.totaldescuentoscodigotipo)
    '    'writer.WriteStartElement("cbc:PayableAmount")
    '    'writer.WriteAttributeString("currencyID", NotaCreditoBE.t30_tipomoneda_c02) 'NotaCreditoBE.tipomoneda)
    '    'writer.WriteString(NotaCreditoBE.t28_totaldescuentos) ' .totaldescuentos)
    '    'writer.WriteEndElement()
    '    'writer.WriteEndElement()
    ...
    '    'writer.WriteElementString("cbc:ID", FacturaBE.codigoleyenda)
    '    'writer.WriteElementString("cbc:Value", FacturaBE.leyenda)
    '    'writer.WriteEndElement()
    ...
    '    writer.WriteElementString("cbc:UBLVersionID", NotaDebitoBE.t35_versionubl) '.versionubl)

    '    'La version del CustomizationID es 1.0
    '    writer.WriteElementString("cbc:CustomizationID", NotaDebitoBE.t36_versiondoc) ' .versionestructuradocumento)

    '    writer.WriteElementString("cbc:ID", NotaDebitoBE.t08_numcorrelativo) '.numerocorrelativo)
    '    writer.WriteElementString("cbc:IssueDate", NotaDebitoBE.t01_fecemision) '.fechaemision)
    '    ' writer.WriteElementString("cbc:InvoiceTypeCode", "07")
    '    writer.WriteElementString("cbc:DocumentCurrencyCode", NotaDebitoBE.t30_tipmoneda_c02) 'NotaCreditoBE.tipomoneda)

    '    'Bloques Tres (Nuevo bloque de Nota Debito)
    '    writer.WriteStartElement("cac:DiscrepancyResponse")
    '    writer.WriteElementString("cbc:ReferenceID", NotaDebitoBE.t07_sernumdocafectado) '.serieynumerodocumentoefectado)
    '    writer.WriteElementString("cbc:ResponseCode", NotaDebitoBE.t07_tipnotadebito_c10) '.codigotiponotacredito)
    '    writer.WriteElementString("cbc:Description", NotaDebitoBE.t11_motivo) '.motivoosustento)
    '    writer.WriteEndElement()

    '    'Bloque cuatro (Nuevo bloque de Nota de Debito)
    '    writer.WriteStartElement("cac:BillingReference")
    '    writer.WriteStartElement("cac:InvoiceDocumentReference")
    '    writer.WriteElementString("cbc:ID", NotaDebitoBE.t07_sernumdocafectado) '.serieynumerodocumentoefectado)
    '    writer.WriteElementString("cbc:DocumentTypeCode", NotaDebitoBE.t33_tipdoc_c01)
    '    writer.WriteEndElement()
    '    writer.WriteEndElement()
    ...
    '    writer.WriteElementString("cbc:CustomerAssignedAccountID", NotaDebitoBE.t09_numdocadquiriente)
    '    writer.WriteElementString("cbc:AdditionalAccountID", NotaDebitoBE.t09_tipdocadquiriente_c06)
    '    writer.WriteStartElement("cac:Party")
    '    writer.WriteStartElement("cac:PartyLegalEntity")
    '    writer.WriteStartElement("cbc:RegistrationName")
    '    writer.WriteCData(NotaDebitoBE.t10_nomadquiriente)
    '    writer.WriteEndElement()
    '    writer.WriteEndElement()
    '    writer.WriteEndElement()
    '    writer.WriteEndElement()

    '    'bloque seis diferente a la nota de debito
    '    writer.WriteStartElement("cac:TaxTotal")
    '    Tools.TagNodoAtributoValorValor(writer, "cbc:TaxAmount", "currencyID", NotaDebitoBE.t30_tipmoneda_c02, NotaDebitoBE.t24_totaligv)
    '    writer.WriteStartElement("cac:TaxSubtotal")
    '    Tools.TagNodoAtributoValorValor(writer, "cbc:TaxAmount", "currencyID", NotaDebitoBE.t30_tipmoneda_c02, NotaDebitoBE.t24_subtotaligv)

    '    writer.WriteStartElement("cac:TaxCategory")
    '    writer.WriteStartElement("cac:TaxScheme")
    '    writer.WriteElementString("cbc:ID", NotaDebitoBE.t24_tiptributo_c05)
    '    writer.WriteElementString("cbc:Name", NotaDebitoBE.t24_nomtributo_c05)
    '    writer.WriteElementString("cbc:TaxTypeCode", NotaDebitoBE.t24_tiptributointernacional_c05)
    ...
    '    Tools.TagNodoAtributoValorValor(writer, "cbc:PayableAmount", "currencyID", NotaDebitoBE.t30_tipmoneda_c02, NotaDebitoBE.t24_totaligv) '.sumatoriaigvtotal) ') 'NotaCreditoBE.tipomoneda, NotaCreditoBE.sumatoriaigvtotal)
    '    writer.WriteEndElement()


    '    'bloque ocho: Este bloque tiene los items de la nota debito
    '    For Each Item In NotaDebitoBE.Detalle

    '        writer.WriteStartElement("cac:DebitNoteLine")
    '        writer.WriteElementString("cbc:ID", Item.t34_numordenitem)
    '        Tools.TagNodoAtributoValorValor(writer, "cbc:DebitedQuantity", "unitCode", Item.t12_tipunidadmedida_c03, Item.t13_cantidad)
    '        Tools.TagNodoAtributoValorValor(writer, "cbc:LineExtensionAmount", "currencyID", NotaDebitoBE.t30_tipmoneda_c02, Item.t17_preciounitario * Item.t13_cantidad) 'Precio * Cantidad sin igv

    '        writer.WriteStartElement("cac:PricingReference")
    '        writer.WriteStartElement("cac:AlternativeConditionPrice")
    '        Tools.TagNodoAtributoValorValor(writer, "cbc:PriceAmount", "currencyID", NotaDebitoBE.t30_tipmoneda_c02, Item.t17_preciounitario) 'Precio venta incluido IGV
    ...
    '        'REVISAR
    '        writer.WriteStartElement("cac:TaxTotal")
    '        Tools.TagNodoAtributoValorValor(writer, "cbc:TaxAmount", "currencyID", NotaDebitoBE.t30_tipmoneda_c02, Item.t18_totalitem)
    '        writer.WriteStartElement("cac:TaxSubtotal")
    '        Tools.TagNodoAtributoValorValor(writer, "cbc:TaxAmount", "currencyID", NotaDebitoBE.t30_tipmoneda_c02, Item.t18_subtotalitem)
    '        writer.WriteStartElement("cac:TaxCategory")
    ...
    '        writer.WriteElementString("cbc:Name", Item.t18_nomtributo_c05.ToString.Trim)
    '        writer.WriteElementString("cbc:TaxTypeCode", Item.t18_tiptributointernacional_c05)
    '        writer.WriteEndElement()
    '        writer.WriteEndElement()
    '        writer.WriteEndElement()
    '        writer.WriteEndElement()
    ...
    '        Tools.TagNodoAtributoValorValor(writer, "cbc:PriceAmount", "currencyID", NotaDebitoBE.t30_tipmoneda_c02, Item.t16_valorunitario)
    '        writer.WriteEndElement()
    '        writer.WriteEndElement()
    '    Next
    ...
    '    SaveRutaArchivoXML(IDNotaDebito, RutaArchivo & NombreArchivo & ExtensionArchivoXML)
    ...
    'Public Sub CreateFileXMLV21(IDNotaDebito As Int32)
    '    'Se carga los datos el emisor
    '    EmisorBE = EmisorDAO.GetByID(1)
    ...
    '    'Parte2
    '    writer.WriteElementString("cbc:UBLVersionID", NotaDebitoBE.t35_versionubl)
    '    'Parte2

    '    'Parte3
    '    writer.WriteElementString("cbc:CustomizationID", NotaDebitoBE.t36_versiondoc)
    '    'Parte3

    '    'Parte5
    '    writer.WriteElementString("cbc:ID", NotaDebitoBE.t08_numcorrelativo)
    '    'Parte5
    '    'Parte6
    '    writer.WriteElementString("cbc:IssueDate", NotaDebitoBE.t01_fecemision)
    '    'Parte6
    '    'Parte7
    '    writer.WriteElementString("cbc:IssueTime", NotaDebitoBE.HoraEmision) 'hh-mm-ss.0z agregar dato de hora
    '    'Parte7

    '    'Parte10 cbc:Note
    '    writer.WriteStartElement("cbc:Note")
    '    writer.WriteAttributeString("languageLocaleID", "1000")
    '    writer.WriteString(NotaDebitoBE.descripcionleyenda)
    '    writer.WriteEndElement()
    '    'Parte10 cbc:Note
    ...
    '    writer.WriteString(NotaDebitoBE.t30_tipmoneda_c02)
    '    writer.WriteEndElement()
    '    'Parte11 cbc:DocumentCurrencyCode
    ...
    '    'Parte 8 y 9
    '    writer.WriteStartElement("cac:DiscrepancyResponse")
    '    writer.WriteElementString("cbc:ReferenceID", NotaDebitoBE.t07_sernumdocafectado)
    '    writer.WriteElementString("cbc:ResponseCode", NotaDebitoBE.t07_tipnotadebito_c10)
    '    writer.WriteStartElement("cbc:Description")
    '    writer.WriteCData(NotaDebitoBE.t11_motivo)
    '    writer.WriteEndElement()
    '    writer.WriteEndElement()
    '    'Parte 8 y 9
    ...
    '    writer.WriteElementString("cbc:ID", NotaDebitoBE.t07_sernumdocafectado)
    '    writer.WriteElementString("cbc:DocumentTypeCode", NotaDebitoBE.t33_tipdoc_c01)
    ...
    '    writer.WriteStartElement("cac:PartyIdentification")
    '    writer.WriteStartElement("cbc:ID")
    '    writer.WriteAttributeString("schemeID", NotaDebitoBE.t09_tipdocadquiriente_c06)
    '    writer.WriteAttributeString("schemeName", "Documento de Identidad")
    '    writer.WriteAttributeString("schemeAgencyName", "PE:SUNAT")
    '    writer.WriteAttributeString("schemeURI", "urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo06")
    '    writer.WriteString(NotaDebitoBE.t09_numdocadquiriente)  'Se agrega tag CDATA. Se usa el nombre legal de la empresa emisora
    '    writer.WriteEndElement()
    '    writer.WriteEndElement()

    '    writer.WriteStartElement("cac:PartyName")
    '    writer.WriteStartElement("cbc:Name")
    '    writer.WriteCData(NotaDebitoBE.t10_nomadquiriente)  'Se agrega tag CDATA. Se usa el nombre legal de la empresa emisora
    '    writer.WriteEndElement()
    '    writer.WriteEndElement()
    ...
    '    writer.WriteAttributeString("schemeAgencyName", "PE:SUNAT")
    '    writer.WriteAttributeString("schemeURI", "urn:pe:gob:sunat:cpe:see: gem:catalogos:catalogo06")
    '    writer.WriteString(NotaDebitoBE.t09_numdocadquiriente)
    '    writer.WriteEndElement()
    ...
    '    writer.WriteStartElement("cac:AddressLine")
    '    writer.WriteElementString("cbc:Line", NotaDebitoBE.DireccionAdquiriente)
    '    writer.WriteEndElement()
    ...
    '    writer.WriteStartElement("cac:TaxTotal")
    '    'If Double.Parse(NotaDebitoBE.t24_totaligv) + Double.Parse(NotaDebitoBE.t25_totalisc) + Double.Parse(NotaDebitoBE.t26_totalotrostributos) > 0 Then

    '    writer.WriteStartElement("cbc:TaxAmount")
    '    writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02)
    '    writer.WriteString(Math.Round(Double.Parse(NotaDebitoBE.t24_totaligv) + Double.Parse(NotaDebitoBE.t25_totalisc) + Double.Parse(NotaDebitoBE.t26_totalotrostributos), 2).ToString("0.00", CultureInfo.InvariantCulture))
    '    writer.WriteEndElement()


    '    Dim SumatoriaTotal As Double
    '    Dim SumatoriaImpuesto As Double
    '    For Each item As NotaDebitoItem In NotaDebitoBE.Detalle
    ...
    '        writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02)
    '        writer.WriteString(Math.Round(Double.Parse(NotaDebitoBE.t20_totalvalorventagravadas), 2).ToString("0.00", CultureInfo.InvariantCulture))
    '        writer.WriteEndElement()
    ...
    '        writer.WriteStartElement("cbc:TaxableAmount")
    '        writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02)
    '        writer.WriteString(Math.Round(Double.Parse(NotaDebitoBE.t22_totalvalorventaexonerada), 2).ToString("0.00", CultureInfo.InvariantCulture))
    '        writer.WriteEndElement()
    ...
    '        writer.WriteStartElement("cbc:TaxableAmount")
    '        writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02)
    '        writer.WriteString(Math.Round(Double.Parse(NotaDebitoBE.t21_totalvalorventainafectas), 2).ToString("0.00", CultureInfo.InvariantCulture))
    '        writer.WriteEndElement()
    ...
    '    writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02)
    '    writer.WriteString(Math.Round(Double.Parse(NotaDebitoBE.t20_totalvalorventagravadas) - Double.Parse(NotaDebitoBE.t28_totaldescuentos), 2).ToString("0.00", CultureInfo.InvariantCulture))
    '    writer.WriteEndElement()
    '    'Parte30
    ...
    '    writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02)
    '    writer.WriteString(Math.Round(Double.Parse(NotaDebitoBE.t29_totalimporte) - Double.Parse(NotaDebitoBE.t27_totalotroscargos), 2).ToString("0.00", CultureInfo.InvariantCulture))
    '    writer.WriteEndElement()
    '    'Parte31
    ...
    '    writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02)
    '    writer.WriteString(NotaDebitoBE.t28_totaldescuentos)
    '    writer.WriteEndElement()
    '    'Parte32
    ...
    '    writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02)
    '    writer.WriteString(NotaDebitoBE.t27_totalotroscargos)
    '    writer.WriteEndElement()
    '    'Parte33
    ...
    '    writer.WriteStartElement("cbc:PayableAmount")
    '    writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02)
    '    writer.WriteString(Math.Round(Double.Parse(NotaDebitoBE.t29_totalimporte) + Double.Parse(NotaDebitoBE.t28_totaldescuentos), 2).ToString("0.00", CultureInfo.InvariantCulture)) 'tener en cuenta este campo es el importe total de la venta
    '    writer.WriteEndElement()
    '    'Parte34
    ...
    '        writer.WriteStartElement("cbc:LineExtensionAmount")
    '        writer.WriteAttributeString("currencyID", NotaDebitoBE.t30_tipmoneda_c02) 'Nuevo Campo Agregar Catalogo 06
    ...
    '            writer.WriteElementString("cbc:Name", item.t18_nomtributo_c05)
    '            writer.WriteElementString("cbc:TaxTypeCode", item.t18_tiptributointernacional_c05)
    ...
    '            writer.WriteElementString("cbc:Name", item.t19_nomtributo_c05)
    '            writer.WriteElementString("cbc:TaxTypeCode", item.t19_tiptributointernacional_c05)
    ...
    '    FirmaXMLDAO.Create(EmisorBE, RutaArchivo & NombreArchivo & ExtensionArchivoXML, "08")
    ...
    '    'Parte6
    '    'Parte7
    '    writer.WriteElementString("cbc:IssueTime", NotaDebitoBE.t01_horaemision) 'hh-mm-ss.0z agregar dato de hora
    '    'Parte7

    '    'Parte10 cbc:Note
    '    writer.WriteStartElement("cbc:Note")
    '    writer.WriteAttributeString("languageLocaleID", "1000")
    '    writer.WriteString(NotaDebitoBE.t37_descripcionleyenda)
    '    writer.WriteEndElement()
    '    'Parte10 cbc:Note
    ...
    '    writer.WriteStartElement("cac:PartyIdentification")
    '    writer.WriteStartElement("cbc:ID")
    '    writer.WriteAttributeString("schemeID", IIf(NotaDebitoBE.t09_tipdocadquiriente_c06 = "-", "0", NotaDebitoBE.t09_tipdocadquiriente_c06))
    '    writer.WriteAttributeString("schemeName", "Documento de Identidad")
    '    writer.WriteAttributeString("schemeAgencyName", "PE:SUNAT")
    '    writer.WriteAttributeString("schemeURI", "urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo06")
    '    writer.WriteString(NotaDebitoBE.t09_numdocadquiriente)  'Se agrega tag CDATA. Se usa el nombre legal de la empresa emisora
    ...
    'Public Function SignatureXML(IDNotaDebito As Int32) As String
    '    'Se carga los datos el emisor
    '    EmisorBE = EmisorDAO.GetByID(1)
    ...
    '    Try
    '        Dim local_xmlArchivo As String = NotaDebitoBE.RutaComprobanteXML
    '        Dim local_nombreXML As String = System.IO.Path.GetFileName(local_xmlArchivo)
    '        Dim local_typoDocumento As String = "08"
    ...
    '        Me.SaveValorFirma(IDNotaDebito, ValorFirma)
    ...
    '    Return Result
    'End Function
    Public Function ZipXML(IDNotaDebito As Int32) As String
        'Se carga los datos el emisor
        EmisorBE = EmisorDAO.GetByID(1)
        ...
        Dim RutaArchivoZIP As String = Path.ChangeExtension(NotaDebitoBE.RutaComprobanteXML, "zip")
        ...
        Using zipToOpen As FileStream = New FileStream(RutaArchivoZIP, FileMode.Create)
            Using archive As ZipArchive = New ZipArchive(zipToOpen, ZipArchiveMode.Create)
                Dim readmeEntry As ZipArchiveEntry = archive.CreateEntry(Path.GetFileName(NotaDebitoBE.RutaComprobanteXML))
                Dim writer As StreamWriter = New StreamWriter(readmeEntry.Open())

                writer.Write(My.Computer.FileSystem.ReadAllText(NotaDebitoBE.RutaComprobanteXML))
                writer.Flush()
                writer.Close()
            End Using
        End Using
    ...
    Public Function GetByID(Optional IDNotaDebito As Int32 = 0) As NotaDebitoBE
        Dim cnx As New SqlConnection(ConexionDAO.GetConexionDBComprobantes)
        Dim cmd As New SqlCommand
        Dim dr As SqlDataReader = Nothing
        Dim NotaDebitoBE As New NotaDebitoBE
        Dim NotaDebitoItems As New List(Of NotaDebitoItem)

        'Se el parametro es cero=
        If IDNotaDebito = 0 Then
            IDNotaDebito = Me.IDNotaDebito
        End If

        With cmd
            .Connection = cnx
            .CommandType = CommandType.StoredProcedure
            .CommandText = "coe_nota_debito_get_id"
            .Parameters.Add("@idnotadebito", SqlDbType.Int).Value = IDNotaDebito
        End With
        ...
        Try
            ...
            If dr.HasRows Then
                While dr.Read
                    ...
                    With NotaDebitoBE
                        .idnotadebito = dr.ReadNullAsEmptyString("idnotadebito")
                        .idcomprobante = dr.ReadNullAsEmptyString("idcomprobante")
                        .t01_fecemision = dr.ReadNullAsEmptyString("t01_fecemision")
                        .t01_horaemision = dr.ReadNullAsEmptyString("t01_horaemision")
                        .t07_sernumdocafectado = dr.ReadNullAsEmptyString("t07_sernumdocafectado")
                        .t07_tipnotadebito_c10 = dr.ReadNullAsEmptyString("t07_tipnotadebito_c10")
                        ...
                        .t20_totalvalorventagravadas = dr.ReadNullAsEmptyString("t20_totalvalorventagravadas")
                        ...
                        .t30_tipmoneda_c02 = dr.ReadNullAsEmptyString("t30_tipmoneda_c02")
                        ...
                        .t35_versionubl = dr.ReadNullAsEmptyString("t35_versionubl")
                        .t36_versiondoc = dr.ReadNullAsEmptyString("t36_versiondoc")
                        .t37_descripcionleyenda = dr.ReadNullAsEmptyString("t37_descripcionleyenda")
                ...
                If dr.HasRows Then
                    While dr.Read
                        Dim BE As New NotaDebitoItem
                        With BE
                            .idnotadebitodetalle = dr.ReadNullAsEmptyString("idnotadebitodetalle")
                            .idnotadebito = dr.ReadNullAsEmptyString("idnotadebito")
                            ...
                            .t19_tipsistema_c08 = dr.ReadNullAsEmptyString("t19_tipsistema_c08")
                        ...
                        NotaDebitoItems.Add(BE)
                    End While
                End If

                NotaDebitoBE.Detalle = NotaDebitoItems
            End If
        Catch ex As Exception
    ...
    Public Function GetByReporteID() As DataTable
        ...
        With cmd
            .Connection = cnx
            .CommandType = CommandType.StoredProcedure
            .CommandText = "coe_nota_debito_get_id_rpt"
            .Parameters.Add("@idnotadebito", SqlDbType.Int).Value = Me.IDNotaDebito
        End With
        ...
        Return dt
    End Function
    Public Function GetByIDXML(IDNotaDebito As Int32) As String
        Dim cnx As New SqlConnection(ConexionDAO.GetConexionDBComprobantes)
        Dim cmd As New SqlCommand
        ...
        With cmd
            .Connection = cnx
            .CommandType = CommandType.StoredProcedure
            .CommandText = "coe_nota_debito_get_id_xml"
            .Parameters.Add("@idnotadebito", SqlDbType.Int).Value = IDNotaDebito
        End With
    ...
    Public Function GetByAll(FechaInicial As Date, FechaFinal As Date) As DataTable
        ...
        With cmd
            .Connection = cnx
            .CommandType = CommandType.StoredProcedure
            .CommandText = "coe_nota_debito_get_all"
    ...
    Public Function SaveRutaArchivoXML(IDNotaDebito As Int32, RutaCarpetaXML As String) As Boolean
        Dim cnx As New SqlConnection(ConexionDAO.GetConexionDBComprobantes)
        Dim cmd As New SqlCommand
        Dim Result As Boolean = False
        ...
        With cmd
            .Connection = cnx
            .CommandType = CommandType.StoredProcedure
            .CommandText = "coe_nota_debito_upd_ruta"
            .Parameters.Add("@idnotadebito", SqlDbType.Int).Value = IDNotaDebito
    ...
    End Function
    Public Function SaveRutaArchivoCdrXML(IDNotaDebito As Int32, RutaCarpetaCdrXML As String) As Boolean
        Dim cnx As New SqlConnection(ConexionDAO.GetConexionDBComprobantes)
        Dim cmd As New SqlCommand
        Dim Result As Boolean = False
        ...
        With cmd
            .Connection = cnx
            .CommandType = CommandType.StoredProcedure
            .CommandText = "coe_nota_debito_upd_ruta_cdr"
            .Parameters.Add("@idnotadebito", SqlDbType.Int).Value = IDNotaDebito
    ...
    End Function
    Public Function SaveValorFirma(IDNotaDebito As Int32, ValorFirma As String) As Boolean
        Dim cnx As New SqlConnection(ConexionDAO.GetConexionDBComprobantes)
        Dim cmd As New SqlCommand
        Dim Result As Boolean = False
        ...
        With cmd
            .Connection = cnx
            .CommandType = CommandType.StoredProcedure
            .CommandText = "coe_nota_debito_upd_firma"
            .Parameters.Add("@idnotadebito", SqlDbType.Int).Value = IDNotaDebito
    ...
    End Function
    Public Function SaveConstanciaRecepcionZIP(IDNotaDebito As Int32, ContenidoArchivoZIP As Byte()) As Boolean
        Dim Result As Boolean = False
        Dim NombreArchivo As String = String.Empty
        ...
        Try
            ...
            NombreArchivo = Path.GetFileNameWithoutExtension(NotaDebitoBE.RutaComprobanteXML)
            ...
            NombreArchivo = Path.GetDirectoryName(NotaDebitoBE.RutaComprobanteXML) & "\" & NombreArchivo
            ...
            Me.SaveRutaArchivoCdrXML(IDNotaDebito, Path.ChangeExtension(NombreArchivo, ".xml"))

            'Se lee el contenido del archivo XML y se lee contenido
            Me.SaveConstanciaRecepcionXML(IDNotaDebito)
        ...
        Return Result
    End Function
    Public Function SaveConstanciaRecepcionXML(IDNotaDebito As Int32) As Boolean
        Dim Result As Boolean = False
        ...
        'Se obtiene el archivo XML
        Dim ReaderXML As XmlTextReader = New XmlTextReader(NotaDebitoBE.RutaRespuestaSunatXML)
        ...
        With cmd
            .Connection = cnx
            .CommandType = CommandType.StoredProcedure
            .CommandText = "coe_nota_debito_upd_estado"
            .Parameters.Add("@idnotadebito", SqlDbType.Int).Value = IDNotaDebito
    ...
    Public Function SaveExcepcion(BE As ExcepcionBE) As Boolean
        ...
        With cmd
            .Connection = cnx
            .CommandType = CommandType.StoredProcedure
            .CommandText = "coe_nota_debito_upd_excepcion"
            .Parameters.Add("@idnotadebito", SqlDbType.Int).Value = BE.IDComprobante
    ...
    End Function
    Public Function SaveEstadoWeb(IDNotaDebito As Int32, IDEstadoWeb As eEstadoWeb, FechaWeb As DateTime) As Boolean
        Dim cnx As New SqlConnection(ConexionDAO.GetConexionDBComprobantes)
        Dim cmd As New SqlCommand
        Dim Result As Boolean = False
        ...
        With cmd
            .Connection = cnx
            .CommandType = CommandType.StoredProcedure
            .CommandText = "coe_nota_debito_estado_web"
            .Parameters.Add("@idnotadebito", SqlDbType.Int).Value = IDNotaDebito
