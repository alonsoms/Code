...
Namespace SunatSE
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="http://service.sunat.gob.pe", ConfigurationName:="SunatSE.billService")>  _
    Public Interface billService
        ...
        Function getStatus(ByVal request As SunatSE.getStatusRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="status")> SunatSE.getStatusResponse
        
        <System.ServiceModel.OperationContractAttribute(Action:="urn:getStatus", ReplyAction:="*")>  _
        Function getStatusAsync(ByVal request As SunatSE.getStatusRequest) As System.Threading.Tasks.Task(Of SunatSE.getStatusResponse)
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendBill", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendBill(ByVal request As SunatSE.sendBillRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="applicationResponse")> SunatSE.sendBillResponse
        
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendBill", ReplyAction:="*")>  _
        Function sendBillAsync(ByVal request As SunatSE.sendBillRequest) As System.Threading.Tasks.Task(Of SunatSE.sendBillResponse)
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendPack", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendPack(ByVal request As SunatSE.sendPackRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatSE.sendPackResponse
        
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendPack", ReplyAction:="*")>  _
        Function sendPackAsync(ByVal request As SunatSE.sendPackRequest) As System.Threading.Tasks.Task(Of SunatSE.sendPackResponse)
        
        'CODEGEN: Parameter 'ticket' requires additional schema information that cannot be captured using the parameter mode. The specific attribute is 'System.Xml.Serialization.XmlElementAttribute'.
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendSummary", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendSummary(ByVal request As SunatSE.sendSummaryRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatSE.sendSummaryResponse
        
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendSummary", ReplyAction:="*")>  _
        Function sendSummaryAsync(ByVal request As SunatSE.sendSummaryRequest) As System.Threading.Tasks.Task(Of SunatSE.sendSummaryResponse)
    End Interface
    ...
    Partial Public Class getStatusResponse
        ...
        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://service.sunat.gob.pe", Order:=0),  _
         System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)>  _
        Public status As SunatSE.statusResponse
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal status As SunatSE.statusResponse)
            MyBase.New
            Me.status = status
        End Sub
    End Class
    ...
    Public Interface billServiceChannel
        Inherits SunatSE.billService, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class billServiceClient
        Inherits System.ServiceModel.ClientBase(Of SunatSE.billService)
        Implements SunatSE.billService
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatSE_billService_getStatus(ByVal request As SunatSE.getStatusRequest) As SunatSE.getStatusResponse Implements SunatSE.billService.getStatus
            Return MyBase.Channel.getStatus(request)
        End Function
        
        Public Function getStatus(ByVal ticket As String) As SunatSE.statusResponse
            Dim inValue As SunatSE.getStatusRequest = New SunatSE.getStatusRequest()
            inValue.ticket = ticket
            Dim retVal As SunatSE.getStatusResponse = CType(Me,SunatSE.billService).getStatus(inValue)
            Return retVal.status
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatSE_billService_getStatusAsync(ByVal request As SunatSE.getStatusRequest) As System.Threading.Tasks.Task(Of SunatSE.getStatusResponse) Implements SunatSE.billService.getStatusAsync
            Return MyBase.Channel.getStatusAsync(request)
        End Function
        
        Public Function getStatusAsync(ByVal ticket As String) As System.Threading.Tasks.Task(Of SunatSE.getStatusResponse)
            Dim inValue As SunatSE.getStatusRequest = New SunatSE.getStatusRequest()
            inValue.ticket = ticket
            Return CType(Me,SunatSE.billService).getStatusAsync(inValue)
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatSE_billService_sendBill(ByVal request As SunatSE.sendBillRequest) As SunatSE.sendBillResponse Implements SunatSE.billService.sendBill
        ...
        Public Function sendBill(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As Byte()
            Dim inValue As SunatSE.sendBillRequest = New SunatSE.sendBillRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatSE.sendBillResponse = CType(Me,SunatSE.billService).sendBill(inValue)
            Return retVal.applicationResponse
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatSE_billService_sendBillAsync(ByVal request As SunatSE.sendBillRequest) As System.Threading.Tasks.Task(Of SunatSE.sendBillResponse) Implements SunatSE.billService.sendBillAsync
            Return MyBase.Channel.sendBillAsync(request)
        End Function
        
        Public Function sendBillAsync(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As System.Threading.Tasks.Task(Of SunatSE.sendBillResponse)
            Dim inValue As SunatSE.sendBillRequest = New SunatSE.sendBillRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Return CType(Me,SunatSE.billService).sendBillAsync(inValue)
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatSE_billService_sendPack(ByVal request As SunatSE.sendPackRequest) As SunatSE.sendPackResponse Implements SunatSE.billService.sendPack
        ...
        Public Function sendPack(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatSE.sendPackRequest = New SunatSE.sendPackRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatSE.sendPackResponse = CType(Me,SunatSE.billService).sendPack(inValue)
            Return retVal.ticket
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatSE_billService_sendPackAsync(ByVal request As SunatSE.sendPackRequest) As System.Threading.Tasks.Task(Of SunatSE.sendPackResponse) Implements SunatSE.billService.sendPackAsync
            Return MyBase.Channel.sendPackAsync(request)
        End Function
        
        Public Function sendPackAsync(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As System.Threading.Tasks.Task(Of SunatSE.sendPackResponse)
            Dim inValue As SunatSE.sendPackRequest = New SunatSE.sendPackRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Return CType(Me,SunatSE.billService).sendPackAsync(inValue)
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatSE_billService_sendSummary(ByVal request As SunatSE.sendSummaryRequest) As SunatSE.sendSummaryResponse Implements SunatSE.billService.sendSummary
        ...
        Public Function sendSummary(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatSE.sendSummaryRequest = New SunatSE.sendSummaryRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatSE.sendSummaryResponse = CType(Me,SunatSE.billService).sendSummary(inValue)
            Return retVal.ticket
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatSE_billService_sendSummaryAsync(ByVal request As SunatSE.sendSummaryRequest) As System.Threading.Tasks.Task(Of SunatSE.sendSummaryResponse) Implements SunatSE.billService.sendSummaryAsync
            Return MyBase.Channel.sendSummaryAsync(request)
        End Function
        
        Public Function sendSummaryAsync(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As System.Threading.Tasks.Task(Of SunatSE.sendSummaryResponse)
            Dim inValue As SunatSE.sendSummaryRequest = New SunatSE.sendSummaryRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Return CType(Me,SunatSE.billService).sendSummaryAsync(inValue)
        End Function
    End Class
End Namespace
